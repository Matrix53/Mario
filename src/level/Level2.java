...
public class Level2 {
    ...
    public static void addStairs(Controller controller, int x, int n, int direction){
        int blocks = n;
        if(direction == 1){
            for(int i = 0;i<n;i++){
                int start = i*34+x;
    ...
    public static void addVerticalWall(Controller controller, int x, int h, int n){
        int height = h;
        for(int i = 0;i<n;i++){
    ...
    public static void addHorizontalWall(Controller controller, int x, int h, int n){
        int pos = x;
        for(int i = 0;i<n;i++){
    ...
    public static void start(){
        ...
        //page 4
        addStairs(controller, 2400, 4, 1);
        addStairs(controller, 2700, 4, 0);
        ...
        //page 5
        addVerticalWall(controller, 3200, 0, 5);
        addVerticalWall(controller, 3300, 0, 9);

        addVerticalWall(controller, 3400, 34*5, 4);
        addVerticalWall(controller, 3400+34*3, 0, 9);
        addHorizontalWall(controller, 3400, 34*5, 3);
        addHorizontalWall(controller, 3400, 34*8, 3);

        addHorizontalWall(controller, 3400+34*3+100, 0, 4);
        addHorizontalWall(controller, 3400+34*3+100, 34*4, 4);
        addHorizontalWall(controller, 3400+34*3+100, 34*8, 4);
        addVerticalWall(controller, 3400+34*3+100, 0, 4);
        addVerticalWall(controller, 3400+34*3+100+34*3, 34*4, 4);

        addVerticalWall(controller, 3400+34*3+100+34*3+100, 0, 9);
